...
// 	$Id: BtaMicroCandR_001.cxx,v 1.2 2001-12-17 17:43:08 Marcel Exp $
//
// Environment:
...
// This Class's Header --
//-----------------------
#include "KangaSchema/BtaMicroCandR_001.h"
...
// Constructors --
//----------------
BtaMicroCandR_001::BtaMicroCandR_001() :
...
{}
/*
BtaMicroCandR_001::BtaMicroCandR_001( const BtaCandidate* aCandidate,
			      RooEvtObjLocReg & reg ) : 
  RooEvtObj<BtaCandidate>(),
...
//-------------
/*
BtaCandidate* BtaMicroCandR_001::transient( RooEvtObjLocReg & reg ) const 
{
...
Bool_t BtaMicroCandR_001::fillRefs( const BtaCandidate* trans, 
			      const RooEvtObjLocReg & reg ) {
  // don't do anything until you have persistent references
  return true;
}
Bool_t BtaMicroCandR_001::fillPointers( BtaCandidate* trans, 
...
*/
// Printing:
void BtaMicroCandR_001::print( std::ostream & ost ) const {
/*
...
void BtaMicroCandR_001::Print( Option_t* option ) const {
/*
  cout << ClassName() << endl;
  print( cout );
  return;
