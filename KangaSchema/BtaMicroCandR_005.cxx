...
// 	$Id: BtaMicroCandR_005.cxx,v 1.2 2001-12-17 17:44:07 Marcel Exp $
//
// Environment:
...
// This Class's Header --
//-----------------------
#include "KangaSchema/BtaMicroCandR_005.h"
...
// Constructors --
//----------------
BtaMicroCandR_005::BtaMicroCandR_005() :
...
{}
/*
BtaMicroCandR_005::BtaMicroCandR_005( const BtaCandidate* aCandidate,
			      RooEvtObjLocReg & reg ) : 
  RooEvtObj<BtaCandidate>(),
...
//-------------
/*
BtaCandidate* BtaMicroCandR_005::transient( RooEvtObjLocReg & reg ) const 
{
...
Bool_t BtaMicroCandR_005::fillRefs( const BtaCandidate* trans, 
			      const RooEvtObjLocReg & reg ) {
  // don't do anything until you have persistent references
  return true;
}
Bool_t BtaMicroCandR_005::fillPointers( BtaCandidate* trans, 
...
*/
// Printing:
void BtaMicroCandR_005::print( std::ostream & ost ) const {
/*
...
void BtaMicroCandR_005::Print( Option_t* option ) const {
/*
  cout << ClassName() << endl;
  print( cout );
  return;
