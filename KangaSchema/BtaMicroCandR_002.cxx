...
// 	$Id: BtaMicroCandR_002.cxx,v 1.2 2001-12-17 17:43:23 Marcel Exp $
//
// Environment:
...
// This Class's Header --
//-----------------------
#include "KangaSchema/BtaMicroCandR_002.h"
...
// Constructors --
//----------------
BtaMicroCandR_002::BtaMicroCandR_002() :
...
{}
/*
BtaMicroCandR_002::BtaMicroCandR_002( const BtaCandidate* aCandidate,
			      RooEvtObjLocReg & reg ) : 
  RooEvtObj<BtaCandidate>(),
...
//-------------
/*
BtaCandidate* BtaMicroCandR_002::transient( RooEvtObjLocReg & reg ) const 
{
...
Bool_t BtaMicroCandR_002::fillRefs( const BtaCandidate* trans, 
			      const RooEvtObjLocReg & reg ) {
  // don't do anything until you have persistent references
  return true;
}
Bool_t BtaMicroCandR_002::fillPointers( BtaCandidate* trans, 
...
*/
// Printing:
void BtaMicroCandR_002::print( std::ostream & ost ) const {
/*
...
void BtaMicroCandR_002::Print( Option_t* option ) const {
/*
  cout << ClassName() << endl;
  print( cout );
  return;
