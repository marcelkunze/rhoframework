...
// 	$Id: BtaMicroCandR_004.cxx,v 1.2 2001-12-17 17:43:52 Marcel Exp $
//
// Environment:
...
// This Class's Header --
//-----------------------
#include "KangaSchema/BtaMicroCandR_004.h"
...
// Constructors --
//----------------
BtaMicroCandR_004::BtaMicroCandR_004() :
...
{}
/*
BtaMicroCandR_004::BtaMicroCandR_004( const BtaCandidate* aCandidate,
			      RooEvtObjLocReg & reg ) : 
  RooEvtObj<BtaCandidate>(),
...
//-------------
/*
BtaCandidate* BtaMicroCandR_004::transient( RooEvtObjLocReg & reg ) const 
{
...
Bool_t BtaMicroCandR_004::fillRefs( const BtaCandidate* trans, 
			      const RooEvtObjLocReg & reg ) {
  // don't do anything until you have persistent references
  return true;
}
Bool_t BtaMicroCandR_004::fillPointers( BtaCandidate* trans, 
...
*/
// Printing:
void BtaMicroCandR_004::print( std::ostream & ost ) const {
/*
...
void BtaMicroCandR_004::Print( Option_t* option ) const {
/*
  cout << ClassName() << endl;
  print( cout );
  return;
