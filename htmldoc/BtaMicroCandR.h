...
// 	$Id: BtaMicroCandR.h,v 1.1.1.1 2002-12-20 15:05:29 marcel Exp $
//
// Description:
...
//
//------------------------------------------------------------------------
#ifndef BTAMICROCANDR_HH
#define BTAMICROCANDR_HH
...
class BtaMicroCandR : public RooEvtObj<BtaCandidate> {
//--------------------
// Instance Members --
//--------------------
...
private:
  ...
  // disallowed:
  BtaMicroCandR( const BtaMicroCandR & );
  const BtaMicroCandR & operator = ( const BtaMicroCandR & );
  
  friend class BtaRooMicroAdapter;

  ClassDef(BtaMicroCandR,1) //Persistent Kanga MicroCandidate
