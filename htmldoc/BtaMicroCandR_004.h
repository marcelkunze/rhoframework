...
// 	$Id: BtaMicroCandR_004.h,v 1.1.1.1 2002-12-20 15:05:29 marcel Exp $
//
// Description:
...
//
//------------------------------------------------------------------------
#ifndef BTAMICROCANDR004_HH
#define BTAMICROCANDR004_HH
...
class BtaMicroCandR_004 : public RooEvtObj<BtaCandidate> {
//--------------------
// Instance Members --
//--------------------
...
private:
  ...
  // disallowed:
  BtaMicroCandR_004( const BtaMicroCandR_004 & );
  const BtaMicroCandR_004 & operator = ( const BtaMicroCandR_004 & );
  
  friend class BtaRooMicroAdapter;

  ClassDef(BtaMicroCandR_004,1) //Persistent Kanga MicroCandidate
