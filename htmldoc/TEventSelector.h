...
public:
    ...
    fThetaLow(0.0), fThetaHigh(kTWOPI), 
    fPhiLow(0.0), fPhiHigh(kTWOPI)
    {}
    ...
    void SetTheta(Double_t t1, Double_t t2=kTWOPI) { fThetaLow = t1; fThetaHigh = t2; }
    void SetPhi(Double_t p1, Double_t p2=kTWOPI) { fPhiLow = p1; fPhiHigh = p2; }
