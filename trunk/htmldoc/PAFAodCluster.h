...
public:
    ...
    void Init(TBranchClones* );    
    void Init(PAFAodCluster* );    
    inline Bool_t isValid() { return (fBranches[1]!=NULL); }
    // output
    void PrintOn( std::ostream& o =std::cout) const;

private :
    TSmartPointer *fBranches[NELEM_AODCLUSTER];  //! not stored in root file
