...
Int_t main(int argc,char* argv[]) { RhoToolsTest(1); }
...
public:
    ...
    void PrintAncestors( const TCandidate& cand, ostream& o=cout );
    void Launch();
};
...
void Sputnik::PrintAncestors( const TCandidate& cand, ostream& o) 
{
