========================================================================
    KONSOLENANWENDUNG: NetworkTrainer-Projektübersicht
========================================================================

Diese NetworkTrainer-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre NetworkTrainer-Anwendung besteht.


NetworkTrainer.vcxproj
...
NetworkTrainer.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "NetworkTrainer.pch und eine 
