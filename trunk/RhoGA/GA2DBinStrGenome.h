// $Header: /cvs/hep/rho/RhoGA/GA2DBinStrGenome.h,v 1.3 2002-02-01 03:50:33 marcel Exp $
/* ----------------------------------------------------------------------------
  binstr2.h
  mbwall 19apr95
...
#ifndef NO_STREAMS
  virtual int read(istream & is=std::cin);
  virtual int write (ostream & os=std::cout) const;
#endif
