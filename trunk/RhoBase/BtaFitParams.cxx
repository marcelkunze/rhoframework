...
ClassImp(BtaFitParams)

#include <iostream>
using namespace std;

BtaFitParams::BtaFitParams() : 
fCharge(0),
fXposition(0),
fYposition(0),
fZposition(0),
...
/*
BtaFitParams::BtaFitParams( Double_t mass, 
...
BtaFitParams::BtaFitParams( Double_t charge,
			   const TVector3& pos,
...
BtaFitParams::BtaFitParams( Double_t charge,Float_t* par,Float_t* cov )
:
fChi2(0),
fStatus(unknown),
fFit(0)
...
void BtaFitParams::set( Double_t charge,Float_t* par,Float_t* cov )
{
    setCharge( charge );
    setHelixParms( par );
...
BtaFitParams::BtaFitParams( const BtaFitParams& o ) :
fCharge(o.fCharge),
...
void 
BtaFitParams::setMass( Double_t m )
{
    setP4( m, p3() );
}

void 
BtaFitParams::setMassAndEnergy( Double_t m, Double_t E )
{
    Double_t oldP = p();
    assert( oldP>0 );
...
void 
BtaFitParams::setPosition( const TVector3& pos )
{
    fXposition = pos.X();
    fYposition = pos.Y();
    fZposition = pos.Z();
...
void 
BtaFitParams::setP3( const TVector3& p3 ) 
{
...
void 
BtaFitParams::setP4( Double_t mass, const TVector3& p3 )
{
    fXmomentum = p3.X();
    fYmomentum = p3.Y();
    fZmomentum = p3.Z();
...
void 
BtaFitParams::setP4( const TLorentzVector& p4 )
{
    fXmomentum = p4.X();
    fYmomentum = p4.Y();
    fZmomentum = p4.Z();
...
void 
BtaFitParams::setP7( const TVector3& pos, const TLorentzVector& p4 )
{
    setPos( pos );
    setP4( p4 );
}
...
void 
BtaFitParams::setCov7( const TMatrixD& cov7 )
{
    // position error
...
void 
BtaFitParams::setCov7( const TMatrixD& covPos, const TMatrixD& covP4 )
{
    // position error
...
void 
BtaFitParams::setCov7( const TMatrixD& covPos, const TMatrixD& covP4, const TMatrixD& covPosP4 )
{
    // position error
...
void 
BtaFitParams::setCovP4( const TMatrixD& covP4 )
{
    // position error
...
/*
void
BtaFitParams::set( Double_t mass, 
const BtaAbsRecoObject& recoObject,
const TVector3& origin )
{
...
*/
void 
BtaFitParams::set( const TVector3& pos, 
		  const TLorentzVector& p4, 
		  const TMatrixD& cov7 )
{
    setP7( pos, p4 );
...
Bool_t 
BtaFitParams::operator== (const BtaFitParams& c) const
{ 
    return this == &c;
}

void BtaFitParams::boost(Double_t bx, Double_t by, Double_t bz){
...
void BtaFitParams::setHelixParms(float *p) 
{
    for (int i=0; i<5;i++) fParams[i] = p[i];
}

void BtaFitParams::setHelixCov(float *p)
{
    for (int i=0; i<15;i++) fCov[i] = p[i];
}

void BtaFitParams::printOn(std::ostream& o) const {
...
TError&
BtaFitParams::errorMatrixOfEmcClusters(Double_t clEnergy,Double_t clTheta,Double_t clPhi) const{
...
const TMatrixD&
BtaFitParams::derivsParWrtCoord(TVector3 mom, TVector3 pos, Int_t charge) const 
{
...
const TMatrixD&
BtaFitParams::derivsCoordWrtPar(Float_t *params, Int_t charge, Double_t fltlen) const 
{
...
Double_t 
BtaFitParams::correlation(Int_t x1,Int_t x2,const TMatrixD& deriv,const TMatrixD &cov) const 
{
