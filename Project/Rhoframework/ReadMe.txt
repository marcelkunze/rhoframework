========================================================================
    KONSOLENANWENDUNG: Rhoframework-Projektübersicht
========================================================================

Diese Rhoframework-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre Rhoframework-Anwendung besteht.


Rhoframework.vcxproj
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "Rhoframework.pch und eine 
